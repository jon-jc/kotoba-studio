...
export const en = {
  ...
  onboardingHint: 'Use an API key from your selected provider. Add more providers in Settings → Models, or choose Configure later to use a local model.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  onboardingHint: '请输入所选提供方的 API 密钥。可在设置 → 模型中添加更多提供方，或选择稍后配置以使用本地模型。',
  providerOpenAI: 'OpenAI', providerClaude: 'Anthropic · Claude', providerKimi: 'Kimi · Moonshot AI',
