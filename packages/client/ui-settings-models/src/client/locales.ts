...
export const en = {
  ...
  welcomeBody: 'Welcome to Kotoba Studio: a Japanese and English voice workspace for conversations, code, and agent workflows.\n\nThis developer preview can make mistakes. Review voice transcripts and tool actions, and choose the workspace and model provider for each task.',
  welcomeContinue: 'Continue',
  welcomeError: 'The acknowledgement could not be saved. Please try again.',
  onboardingTitle: 'Your models. One workspace.',
  onboardingDescription: 'Connect OpenAI, Claude, Kimi, DeepSeek, or another provider to start building with Kotoba Studio.',
  onboardingHint: 'Save your provider’s API key, then choose its model in chat. Add more providers in Settings → Models, or choose Configure later to use a local model.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  creating: '创建中\u2026',
  welcomeTitle: '内测声明',
  welcomeBody: '欢迎使用 Kotoba Studio：支持日语和英语语音的对话、代码与智能体工作空间。\n\n此开发预览版可能出现错误。请检查语音转写和工具操作，并为每项任务选择工作目录和模型提供方。',
  welcomeContinue: '继续',
  welcomeError: '暂时无法保存确认状态，请重试。',
  onboardingTitle: '你的模型，一个工作空间。',
  onboardingDescription: '连接 OpenAI、Claude、Kimi、DeepSeek 或其他提供方，开始使用 Kotoba Studio。',
  onboardingHint: '保存所选提供方的 API 密钥后，在聊天中选择其模型。可在设置 → 模型中添加更多提供方，或选择稍后配置以使用本地模型。',
  providerOpenAI: 'OpenAI', providerClaude: 'Anthropic · Claude', providerKimi: 'Kimi · Moonshot AI',
